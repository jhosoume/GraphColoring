...
public:
   ...
   /**
    * Write the critical path as a dot file to be handled by the graphviz.
    * @param name Graph name in the .dot file
    * @param file Name of the file to be saved
    * @param edges_colored Selected edges that is part of the critical path
    * @param color         Name of the color of critical path edges
    */
...
void findConnected() {
    ...
    /**
     * Calculate a ranking of the critical path.
     * @param num_paths Number of paths in the ranking to be outputed
     */
    void CriticalPath(int num_paths) {
        ...
        // Create the vector of all the paths
        ...
        // Sorting the paths according ot the size
        std::sort(paths.begin(), paths.end(), pathComparator);
        // Outiputing the results
        std::cout << "--------------------------------" << std::endl;
        ...
        // Getting edges of the longest path
        ...
        // Seaching for the second longest path
        std::cout << "--------------------------------" << std::endl;
    ...
    /**
     * Retrace all the steps (verticies positions) to reach destination vertex.
     * @param  src  Position of the source vertex
     * @param  dest Position of the destination vertex
     * @return      Vector of positions of the verticies in the path
     */
    ...
    /**
     * Output topological order and save as a dot file to be
     * @param name Name of the graph in the dot file
     * @param file Name of the dot file to be saved
     */
...
private:
    ...
    /**
     * Initialize the next matrix (matrix used to restore the full path)
     */
